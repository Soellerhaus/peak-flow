    ...
    editions: [
      {
        ...
        stages: [
          ...
          { stage: 2, stage_name: 'Lermoos → Imst',     komoot_id: '494808701' },
          { stage: 3, stage_name: 'Imst → Mandarfen',   komoot_id: '533027287' },
          { stage: 4, stage_name: 'Mandarfen → Ischgl', komoot_id: null },
      ...
      },
      {
        ...
        stages: [
          { stage: 1, stage_name: 'Garmisch → Lermoos',   komoot_id: null },
          { stage: 2, stage_name: 'Lermoos → Imst',        komoot_id: null },
          { stage: 3, stage_name: 'Imst → St. Anton',      komoot_id: null },
          { stage: 4, stage_name: 'St. Anton → Lech',      komoot_id: null },
          { stage: 5, stage_name: 'Lech → Warth',          komoot_id: null },
          { stage: 6, stage_name: 'Warth → Schröcken',     komoot_id: null },
